/**
 * @fileoverview API endpoint for resending OTP during password reset
 * @module api/auth/resend-otp
 */

/**
 * POST /api/auth/resend-otp
 * Resends OTP to user's registered mobile number
 * - Deletes any existing unused OTPs
